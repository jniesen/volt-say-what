Volt.configure do |config|
  ...
  #######################################
  config.domain = 'volt-say-what.com'
  config.app_name = 'Volt-say-what'
  config.mailer.from = 'Volt-say-what <no-reply@volt-say-what.com>'
  ...
  #
  config.app_secret = 'IFYbGiMHq_3nx-kEJ797ihA6ZcDZ_7oxTGgGroo8XrAaNOK6eJfZToF7KKWObDz2hkk'
